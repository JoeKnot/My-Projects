...
<header id="header">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.php">Kuay<span>.</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="product_form.php" href="product_form.php">Add Product</a></li>
          <li><a class="cart.php" href="cart.php">Cart</a></li>
          
          <li><a class="login.php" href="login.php">Log in</a></li>
